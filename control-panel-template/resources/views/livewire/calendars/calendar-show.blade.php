        ...
        <div class="card-body">
            <main class="calendar-contain">
                ...
                <aside class="calendar__sidebar">
                    ...
                    <h2 class="sidebar__heading">Tydzień nr 10/12</h2>
                    <h3 class="sidebar__heading-h3">Środa<br>Kwiecień 6</h3>
                ...
                <section class="calendar__days">
                    <section class="calendar__top-bar">
                        ...
                        <span class="top-bar__days">Wt.</span>
                        <span class="top-bar__days">Śr.</span>
                        <span class="top-bar__days">Czw.</span>
                        <span class="top-bar__days">Pt.</span>
                        <span class="top-bar__days">Sob.</span>
                        <span class="top-bar__days">Niedz.</span>
                    </section>
                ...
                <section class="calendar__week">
                    ...
                    <span class="calendar__task">Od 0:30 <br>Do 7:20</span>
                    </div>
                    <div class="calendar__day">
                    <span class="calendar__date">2</span>
                    <span class="calendar__task">Od 12:30 <br>Do 21:20</span>
                    </div>
                    <div class="calendar__day">
                    ...
                    <span class="calendar__task">Wolne</span>
                    </div>
                </section>
                ...
                <section class="calendar__week">
                    ...
                    <span class="calendar__task">1Od 0:30 <br>Do 7:20</span>
                    </div>
                    <div class="calendar__day">
